...
export class PrismaStoreSettingsRepository implements IStoreSettingsRepository {
  ...
  private mapToEntity(data: any): StoreSettings {
    return new StoreSettings({
      ...
      cardFeePercent: Number(data.cardFeePercent),
      cardFeeFixed: Number(data.cardFeeFixed),
      pixFeePercent: Number(data.pixFeePercent),
      applyCardFeeToShipping: data.applyCardFeeToShipping,
